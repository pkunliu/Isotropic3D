...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", type=str, default="configs/sd-v2-base.yaml", help="load model from local config (override model_name)")
    parser.add_argument("--ckpt_path", type=str, default="ckpt/sd-v2.1-base-4view.pt", help="path to local checkpoint")
